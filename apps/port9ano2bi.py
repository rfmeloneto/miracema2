...
df_habsport92bi = df_port9ano2bi.drop(columns=['Escola','Ano','Turma','Total'])

layout = html.Div(children=[
    
    dbc.Row( children = [
        dbc.Col(dcc.Dropdown(df_port9ano2bi['Escola'].unique(), value='E. M. E. C Boanerges Moreira de Paula', style ={'margin-top':10, 'margin-left':5}, id='drop-downP192bi',), width=4),
        dbc.Col(dcc.Dropdown(df_port9ano2bi['Turma'].unique(), value='U', style ={'margin-top':10, 'margin-left':5}, id='drop-down192bi',), width=2)] ),
    html.Br(),
    dbc.Row(
            children=[
...
@app.callback(
    ...
    Input('drop-downP192bi','value'),
)
def habtotal(turma, escola):
    dff= df_port9ano2bi.loc[df_port9ano2bi['Escola']==escola]
...
def acertos(hab, turma,escola):
    df = df_port9ano2bi.loc[df_port9ano2bi['Escola']==escola]
...
def habs(turma, escola):
    d = df_port9ano2bi.loc[df_port9ano2bi['Escola']==escola]
